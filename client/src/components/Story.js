          ...
          <div className="flex-[0.55] text-ellipsis mx-6 gap-2">
            <section className="flex gap-2 justify-center items-center pt-2">
              ...
              <div className="flex gap-2 items-center">
                <p className="font-base text-base">{(story.full_name.split(" ")).length > 1 ? story.full_name.split(" ")[0] + ' ' +  Array.from(story.full_name.split(" ")[2])[0] + '.' : story.full_name.split(" ")[0] && story.full_name.split(" ")[1]}</p>
              </div>
